...
INSERT INTO usuarios (nombreusuario, claveacceso, apellidos, nombres) VALUES
	('ARTURO', '123456', 'Napa Baca', 'Luis Arturo'),
...
-- Defecto: SENATI
UPDATE usuarios SET
	claveacceso = '$2y$10$1/iMAtBQFAONpffj9wgXb.KX7uPgS5Ui/e.Ss.7MuoimXrO0.PNT.'
	WHERE idusuario = 1;

UPDATE usuarios SET
	claveacceso = '$2y$10$aChkfY5BhzUIzoLWgNOSkOVML.3OHrE339Lgsj4Q7KOUKfXKsI5xS'
	WHERE idusuario = 2;
...
CALL spu_usuarios_login('ARTURO');
